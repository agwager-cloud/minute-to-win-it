...
export const GAMES: GameDefinition[] = [
  ...
  { id:'blind-beat', title:'Blind Beat', symbol:'🥁', category:'RHYTHM + MEMORY', tagline:'Lock onto the pulse, then keep it when the cue disappears.', duration:'8 bars', playable:true, instructions:['Follow and tap with the visible metronome for 4 bars.','Then the visual cue disappears for another 4 bars. Keep tapping at the same tempo.','Your blind taps are scored by total timing drift from the hidden beat. Slightly early or late taps still count; only genuine missed beats and extra taps are penalised.','Lowest total drift wins. The game advances automatically even if you stop tapping.'] },
