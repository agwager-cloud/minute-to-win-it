...
export const GAMES: GameDefinition[] = [
  ...
  { id:'time-stop', title:'Time Stop', symbol:'⏱️', category:'INTERNAL TIMING', tagline:'Stop an invisible clock closest to the target time.', duration:'3 targets', playable:true, instructions:['You receive three random target times under 15 seconds.','The clock is visible for the first second, then disappears.','Tap STOP when you think the target time has elapsed.','Lowest total absolute error wins.'] },
  { id:'shrink-ring', title:'Shrink Ring', symbol:'🎯', category:'PRECISION', tagline:'Stop three sweeping rings as the target zone shrinks.', duration:'Coming soon', playable:false, instructions:['Stop the needle inside each green zone.','Every success makes the next ring harder.'] },
