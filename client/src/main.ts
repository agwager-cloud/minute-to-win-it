  ...
  async runRicochet(){
    ...
    stage.innerHTML=`<div class="rico-game">
      ...
      <div class="rico-controls">
        <div class="rico-status-card"><small id="rico-kicker">AIM THE BANK</small><strong id="rico-status">DRAG TO AIM</strong><em id="rico-detail">Aim the bank while the launcher moves vertically</em></div>
        ...
        <div class="rico-tip">💥 Aim the bank · time the moving launcher height · one shot only</div>
      </div>
    </div>`;
